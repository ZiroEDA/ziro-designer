...
/**
 * [data] The nicknames of KiCad's default global symbol library table,
 * `template/sym-lib-table` as the 10.0 install ships it (223 rows, every one
 * `(uri "${KICAD10_SYMBOL_DIR}/<nickname>.kicad_sym")`). The hosted libraries
 * mirror exactly these. Generated from /usr/share/kicad/template/sym-lib-table;
 * regenerate it, do not edit it by hand.
 */
export const GLOBAL_SYM_LIB_NICKNAMES: ReadonlySet<string> = new Set([
  '4xxx',
  '4xxx_IEEE',
  '74xGxx',
  '74xx',
