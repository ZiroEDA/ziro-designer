...
MUTANTS = [
    ('ipc2221 B4 value', 'pcb_calculator/electrical_spacing_values.ts',
    ...
    ('ipc2221 class id A5', 'pcb_calculator/electrical_spacing_values.ts',
     "    id: 'A5',", "    id: 'B5',",
     'pcb_calculator', ['unittests/designer/calc_e2e_power.test.tsx']),
    ('ipc2221 per-volt row', 'pcb_calculator/electrical_spacing_values.ts',
     '[0.0025, 0.005, 0.025, 0.00305, 0.00305, 0.00305, 0.00305],',
     '[0.0025, 0.005, 0.025, 0.00405, 0.00305, 0.00305, 0.00305],',
     'pcb_calculator', ['unittests/designer/calc_e2e_power.test.tsx']),
    ('AWG12 radius', 'pcb_calculator/cable_size.ts',
     '0.00145288, 0.00129413, 0.00115189, 0.00102616,',
     '0.00145288, 0.00129413, 0.00115189, 0.00102716,',
     'pcb_calculator', ['unittests/designer/calc_e2e_power.test.tsx']),
    ('AWG back to the formula', 'pcb_calculator/cable_size.ts',
    ...
    ('bridged tee drops R3', 'designer/src/editors/calculator/panels/panel_rf_attenuators.tsx',
     ...
     'designer', ['unittests/designer/calc_e2e_highspeed.test.tsx']),
    ('Zdiff doubles the dispersed Zodd', 'pcb_calculator/transline/c_microstrip.ts',
    ...
    ('board class Class 1 line width', 'pcb_calculator/board_classes_values.ts',
     '0.8,', '0.85,',
     'pcb_calculator', ['unittests/designer/calc_e2e_memo.test.tsx']),
    ('galvanic first potential', 'pcb_calculator/galvanic_corrosion.ts',
     "'Rh'", "'Rx'",
     'pcb_calculator', ['unittests/designer/calc_e2e_memo.test.tsx']),
    ('eseries display scale', 'pcb_calculator/eseries.ts',
...
def restore():
    run('git checkout -- pcb_calculator designer/src')
