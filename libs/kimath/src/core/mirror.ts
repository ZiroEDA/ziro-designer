...
/**
 * `include/core/mirror.h`: FLIP_DIRECTION and the MIRROR helpers used
 * throughout BOARD_ITEM::Flip and the shapes.
 *
 * KiCad's kimath depends on libs/core; in this workspace @ziroeda/core
 * depends on kimath for its vector type, so the header lives HERE and
 * @ziroeda/core re-exports it - one definition either way.
 */
