...
// ---------------------------------------------------------------------------
// The snapshot list, as LOCAL_HISTORY and DIALOG_RESTORE_LOCAL_HISTORY read it.
// Moved from designer/src/home/local_history.ts on 09-26; the storage (IndexedDB,
// the blob hash) stays in the app's local_history_store.ts.
