...
/**
 * `BITMAPS` (include/bitmaps/bitmaps_list.h): the icon ids a TOOL_ACTION and
 * a menu name their icon by. Bitmap 0 is the invalid marker. The ids are the
 * enum's own order; what a browser draws for each is the designer's icon map.
 */
export enum BITMAPS {
  INVALID_BITMAP = 0,
  about,
