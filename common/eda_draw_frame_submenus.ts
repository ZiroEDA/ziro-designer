...
import { type ConditionalEntry, menuEntry, menuSeparator } from './tool/conditional_menu.js';
import {
  isZoomPresetChecked,
  zoomPresetLabel,
  type ZoomApp,
  ZOOM_LIST,
} from './settings/zoom_settings.js';
import { gridChoiceLabel, type GridEntry } from './settings/grid_settings_ui.js';
