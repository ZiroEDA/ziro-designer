...
/**
 * @deprecated The plain-object (`PcbTable`) form of the table tool's item
 * construction, kept until the tool moves onto `PCB_TABLE` (#636 stage 3). The
 * class port is `pcb_table.ts`; new code uses that one.
 *
 * Placing a table.
